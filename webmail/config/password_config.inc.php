...
$config['password_db_dsn'] = 'pgsql://postfix:DOCKER_DB_PASSWORD@db/postfix';
...
$config['password_query'] = 'UPDATE mailbox SET password=MD5(%p) WHERE username=%u AND active=\'1\'';
